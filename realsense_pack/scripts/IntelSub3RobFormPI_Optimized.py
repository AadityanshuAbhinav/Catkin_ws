...
global s,v, id_list, Coordinates_list,z_anglist,ite,initial_time,move1,move2,move3,poseid,poseidin,goallist,flaglist,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,FormErrMat3,DistErrMat3,PI_error1,PI_error2,PI_error3
s = 0.5
v = np.array([0.05,0])
id_list = None
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       ...
       if ids is not None:
          for i in range(len(ids)):
             rvec1, tvec1, RRmat1, TTmat1, Eulmat1, _ = self.my_estimatePoseSingleMarkers2(corners[i], 0.1, camera_matrix, None,CamPose1,Camrot1)
             print("id ",ids[i]," rvec ",rvec1," Eul",Eulmat1)
          ...
          for i in range(len(ids)):
             ...
             if depth_value > 0:
                ...
                print("id ",ids[i],"cood",[marker_x,marker_y,z_ang])
       ...
       goal = self.Traj(current_time-initial_time,poseidin[4,0:1],v,1)
