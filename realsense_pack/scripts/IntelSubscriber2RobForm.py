...
global s, id_list, Coordinates_list,z_anglist,ite,initial_time,move1,move2,poseid,poseidin,goallist,flaglist,Form,FormErrMat,DistErrMat
s = 0.5
id_list = None
...
goallist = [[0.6,0],[0,0.6],[0.6,0.6]]
Form = [[0.4,-0.2],[-0.4,0.2]]
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,initial_time,initial_time,move1,move2,move3,ctime_mat1,c_mat1,dist_mat1,ctime_mat2,c_mat2,dist_mat2,RelPosition,poseidin, goallist,Form,FormErrMat,DistErrMat
       if ite == 0:
       ...
       self.RelController(poseid[4,:],RelPosition[22,:],Form[0][:],goallist,FormErrMat,DistErrMat,move1,1,c_mat1,ctime_mat1)
       self.RelController(poseid[2,:],RelPosition[14,:],Form[1][:],goallist,FormErrMat,DistErrMat,move2,0,c_mat2,ctime_mat2)
    ...
    def RelController(self,poseid,RelPose,Form,goallist,Formerror,Disterror,move,lead,c_mat,ctime_mat):
       dx = Form[0]
       dy = Form[1]
       l = 0.1
       goal_x = goallist[0][0]
