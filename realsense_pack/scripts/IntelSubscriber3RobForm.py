...
global s, id_list, Coordinates_list,z_anglist,ite,initial_time,move1,move2,move3,poseid,poseidin,goallist,flaglist,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,FormErrMat3,DistErrMat3
s = 0.5
id_list = None
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,initial_time,initial_time,move1,move2,move3,ctime_mat1,c_mat1,dist_mat1,ctime_mat2,c_mat2,dist_mat2,ctime_mat3,c_mat3,dist_mat3,RelPosition,poseidin, goallist,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,FormErrMat3,DistErrMat3
       if ite == 0:
       ...
       self.RelController(poseid[4,:],RelPosition,Form[0][:],goallist,FormErrMat1,DistErrMat1,move1,1,c_mat1,ctime_mat1,4)
       self.RelController(poseid[2,:],RelPosition,Form[1][:],goallist,FormErrMat2,DistErrMat2,move2,0,c_mat2,ctime_mat2,2)
       self.RelController(poseid[3,:],RelPosition,Form[2][:],goallist,FormErrMat3,DistErrMat3,move3,0,c_mat3,ctime_mat3,3)
    ...
    def RelController(self,poseid,RelPose,Form,goallist,Formerror,Disterror,move,lead,c_mat,ctime_mat,idd):
       dx = Form[0]
       dy = Form[1]
       l = 0.1
       goal_x = goallist[0][0]
       ...
       x_dot = K_for_p * (x_form_error) + K_tr*distance_to_goal_x
       y_dot = K_for_p * (y_form_error) + K_tr*distance_to_goal_y
