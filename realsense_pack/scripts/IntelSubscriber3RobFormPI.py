...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       ...
       self.RelController(poseid[4,:],RelPosition,Form[0][:],goallist,FormErrMat1,DistErrMat1,move1,1,c_mat1,ctime_mat1,4,PI_error1)
       self.RelController(poseid[2,:],RelPosition,Form[1][:],goallist,FormErrMat2,DistErrMat2,move2,0,c_mat2,ctime_mat2,2,PI_error2)
       self.RelController(poseid[3,:],RelPosition,Form[2][:],goallist,FormErrMat3,DistErrMat3,move3,0,c_mat3,ctime_mat3,3,PI_error3)
