...
global s, id_list, Coordinates_list,z_anglist,ite,initial_time,move1,move2,move3,poseid,poseidin,goallist,flaglist
s = 0.5
id_list = None
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,initial_time,initial_time,move1,move2,move3,ctime_mat1,c_mat1,dist_mat1,ctime_mat2,c_mat2,dist_mat2,ctime_mat3,c_mat3,dist_mat3,RelPosition,poseidin, goallist
       if ite == 0:
       ...
       if (current_time > initial_time + 8 ):
          ...
          scipy.io.savemat('Aruco.mat', dict(idmat=id_mat1, Coodmat=Coordinates_mat1, zmat=z_ang_mat1, cmat1=c_mat11, ctimemat1 = ctime_mat11, timemat = time_mat1,distmat1 = dist_mat11, cmat2=c_mat22, ctimemat2 = ctime_mat22, distmat2 = dist_mat22,cmat3=c_mat33, ctimemat3 = ctime_mat33, distmat3 = dist_mat33))
    ...
    def RelPos(self, poseid):
       ...
       for i in range(len(poseid)):
          for j in range(len(poseid)):
             RelPosition[i*len(poseid)+j,0] = poseid[i][1]-poseid[j][1]
             RelPosition[i*len(poseid)+j,1] = poseid[i][2]-poseid[j][2]
       return RelPosition  
