...
class CoordsPublisher:
            ...
            while not rospy.is_shutdown():
                ...
                if ids is not None:
                    ...
                    if (3 in ids) and (4 in ids):
                        ...
                        cv2.putText(color_image, marker_text_start, start_center, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
                        cv2.putText(color_image, marker_text_target, target_center, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    ...
    def image_show(self):
        try:
            cv2.imshow("Live Feed of Surface", self.image)
        finally:
            pass
