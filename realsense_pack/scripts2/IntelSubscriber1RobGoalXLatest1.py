...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,move1,ctime_mat,c_mat,dist_mat,poseidin,time_mat,poseid_mat,xdot_mat,initial_time,dist_facmat
       t_k = time.time()
       ...
       if (current_time > 4 ):
          ...
          xdot_mat11 = np.array(xdot_mat)
          scipy.io.savemat('Aruco.mat', dict(idmat=id_mat1, Coodmat=Coordinates_mat1, zmat=z_ang_mat1,cmat1=c_mat11, ctimemat1 = ctime_mat11, timemat = time_mat1,distmat1 = dist_mat11,poseidmat = poseid_mat11,xdotmat = xdot_mat11))
