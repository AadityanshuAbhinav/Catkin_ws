...
global s,ite,move1,move2,poseid,poseidf,poseidin,flaglist,initial_time,v,posehist,n
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,move1,move2,poseidin,posehist,time_mat,poseid_mat,poseidf_mat,initial_time,dist_facmat,v,ctime_mat1,c_mat1,dist_mat1,xerr_mat1,xdot_mat1,ctime_mat2,c_mat2,dist_mat2,xerr_mat2,xdot_mat2,RelPosition,poseidin,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,PI_error1,PI_error2,goalmat
       t_k = time.time()
       ...
       self.RelController(poseid[4,:],RelPosition[22,:],Form[0][:],goal,FormErrMat1,DistErrMat1,move1,1,c_mat1,ctime_mat1,PI_error1,xdot_mat1,xerr_mat1)
       self.RelController(poseid[2,:],RelPosition[14,:],Form[1][:],goal,FormErrMat2,DistErrMat2,move2,0,c_mat2,ctime_mat2,PI_error2,xdot_mat2,xerr_mat2)       
