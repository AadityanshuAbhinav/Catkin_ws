...
global s,ite,move1,move2,poseid,poseidf,poseidin,flaglist,initial_time,v,posehist,prevposeidf
...
prevposeid = np.zeros([5,3])
prevposeidf = np.zeros([5,3])
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,move1,move2,poseidin,posehist,time_mat,poseid_mat,poseidf_mat,initial_time,dist_facmat,v,ctime_mat1,c_mat1,dist_mat1,xerr_mat1,xdot_mat1,ctime_mat2,c_mat2,dist_mat2,xerr_mat2,xdot_mat2,RelPosition,poseidin,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,PI_error1,PI_error2,goalmat,prevposeidf
       t_k = time.time()
       ...
       poseidf[:,2]=poseid[:,2]
       poseidf[:,0:2] = prevposeidf[:,0:2]*np.exp(-0.1*2*np.pi)+poseid[:,0:2]*(1-np.exp(-0.1*2*np.pi))
       ...
       self.RelController(poseidf[4,:],RelPosition[22,:],Form[0][:],goal,FormErrMat1,DistErrMat1,move1,1,c_mat1,ctime_mat1,PI_error1,xdot_mat1,xerr_mat1)
       self.RelController(poseidf[2,:],RelPosition[14,:],Form[1][:],goal,FormErrMat2,DistErrMat2,move2,0,c_mat2,ctime_mat2,PI_error2,xdot_mat2,xerr_mat2)       
       ...
       if (current_time > 4 ):
          ...
          scipy.io.savemat('Aruco.mat', dict(idmat=id_mat1, Coodmat=Coordinates_mat1, zmat=z_ang_mat1, timemat = time_mat1, poseidmat = poseid_mat11, poseidfmat = poseidf_mat11,cmat1=c_mat11, ctimemat1 = ctime_mat11, distmat1 = dist_mat11, xdotmat1 = xdot_mat11, xerrmat1 = xerr_mat11, cmat2=c_mat22, ctimemat2 = ctime_mat22, distmat2 = dist_mat22, xdotmat2 = xdot_mat22, xerrmat2 = xerr_mat22, Disterr1 = distErr1, Formerr1 = FormErr1, Disterr2 = distErr2, Formerr2 = FormErr2,Goalmat = goalmat1))
