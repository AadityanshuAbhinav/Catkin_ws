...
global s,ite,move1,move2,move3,poseid,poseidin,flaglist,initial_time,v,i5list,i4list,i3list
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,move1,move2,move3,poseidin,time_mat,poseid_mat,initial_time,dist_facmat,v,ctime_mat1,c_mat1,dist_mat1,xerr_mat1,xdot_mat1,ctime_mat2,c_mat2,dist_mat2,xerr_mat2,xdot_mat2,ctime_mat3,c_mat3,dist_mat3,xerr_mat3,xdot_mat3,RelPosition,poseidin,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,FormErrMat3,DistErrMat3,PI_error1,PI_error2,PI_error3,goalmat,i5list,i4list,i3list
       t_k = time.time()
       ...
       #self.RelController(poseid[4,:],RelPosition,Form[0][:],goal,FormErrMat1,DistErrMat1,move1,1,c_mat1,ctime_mat1,4,i5list,PI_error1,xdot_mat1,xerr_mat1)
       #self.RelController(poseid[2,:],RelPosition,Form[1][:],goal,FormErrMat2,DistErrMat2,move2,0,c_mat2,ctime_mat2,2,i3list,PI_error2,xdot_mat2,xerr_mat2)
       #self.RelController(poseid[3,:],RelPosition,Form[2][:],goal,FormErrMat3,DistErrMat3,move3,0,c_mat3,ctime_mat3,3,i4list,PI_error3,xdot_mat3,xerr_mat3)       
       ...
       if (current_time > 4 ):
          ...
          scipy.io.savemat('Aruco.mat', dict(idmat=id_mat1, Coodmat=Coordinates_mat1, zmat=z_ang_mat1, timemat = time_mat1, poseidmat = poseid_mat11, cmat1=c_mat11, ctimemat1 = ctime_mat11, distmat1 = dist_mat11, xdotmat1 = xdot_mat11, xerrmat1 = xerr_mat11, cmat2=c_mat22, ctimemat2 = ctime_mat22, distmat2 = dist_mat22, xdotmat2 = xdot_mat22, xerrmat2 = xerr_mat22, cmat3=c_mat33, ctimemat3 = ctime_mat33, distmat3 = dist_mat33, xdotmat3 = xdot_mat33, xerrmat3 = xerr_mat33, Disterr1 = distErr1, Formerr1 = FormErr1, Disterr2 = distErr2, Formerr2 = FormErr2, Disterr3 = distErr3, Formerr3 = FormErr3, vGoalmat = goalmat1))
