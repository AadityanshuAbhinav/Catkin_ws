...
global s,ite,move1,move2,move3,poseid,poseidf,poseidin,flaglist,initial_time,v,i5list,i4list,i3list,n
...
class IntelSubscriber:
    ...
    def IntelSubscriberRGB(self,msg):
       global ite,flaglist,move1,move2,move3,poseidin,posehist,time_mat,poseid_mat,poseidf_mat,initial_time,dist_facmat,v,ctime_mat1,c_mat1,dist_mat1,xerr_mat1,xdot_mat1,ctime_mat2,c_mat2,dist_mat2,xerr_mat2,xdot_mat2,ctime_mat3,c_mat3,dist_mat3,xerr_mat3,xdot_mat3,RelPosition,poseidin,Form,FormErrMat1,DistErrMat1,FormErrMat2,DistErrMat2,FormErrMat3,DistErrMat3,PI_error1,PI_error2,PI_error3,goalmat,i5list,i4list,i3list,n
       t_k = time.time()
