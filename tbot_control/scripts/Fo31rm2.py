...
def controller(min_value_1,min_index_1,min_value_2,min_index_2): 
  global move
  global robot_x, robot_y, robot_theta ,x_form_prev_err ,y_form_prev_err,ite
  
  ForTheta = 45
  dx  = 2*d*np.cos(ForTheta*np.pi/180)
  dy  = 0
  l = 0.07
  ...
  print("Tracking Error2", distance_to_pose)
  print("Formation Errorx2", x_form_error)
  print("Formation Errory2", y_form_error)
  print("angular dev2", np.sin(robot_theta+min_index_1))
  print("angular vel2", -K_ang*np.sin(robot_theta+min_index_1))
  print("robot angle2", robot_theta)
  print("lidar angle2", min_index_1)
  print("Robot state2 ", robot_x, " ", robot_y)
...
def lidar_callback(msg):
  global tlidar_data, lidar_data, d, P_prev1, P_prev2, M_prev1, M_prev2, ite, Z11, Z12, Z21, Z22, M1, Z1prev1, Z1prev2, Z1prev3, M2, Z2prev1, Z2prev2, Z2prev3
  ...
  print(" Prediction1 " , M1," Prediction2 " , M2)
