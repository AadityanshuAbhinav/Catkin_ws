...
def lidar_callback(msg):
  ...
  if (t_l > tlidar_data[0]+8):
    ...
    scipy.io.savemat('lid_robot.mat', dict(t1lid=tlidar_mat, lid=lidar_mat))
...
def odom_callback(data):
  ...
  if (t_o > todom_data[0]+8):
    ...
    scipy.io.savemat('resp_robot.mat', dict(t1=todom_mat, x1=x_mat, y1=y_mat, th1=theta_mat))
  #print("Robot state",robot_theta)
  
  
##########################################################

rospy.init_node('lid2')  # Defines a node with name of Follower
