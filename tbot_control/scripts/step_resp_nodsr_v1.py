...
class Server:
	...
	def lidar_callback(self, msg):
		...
		if self.iter < num_of_iters-1:
			...
			scipy.io.savemat('resp_bot1.mat', dict(t1=self.t_mat, x1=self.x_mat, th1=self.theta_mat, O_t1=self.odom_t_mat, O_v1 = self.odom_v_mat, O_w1=self.odom_w_mat))
...
if __name__ == '__main__':
	...
	pub = rospy.Publisher('tb3_0/cmd_vel', Twist)
	move = Twist()
